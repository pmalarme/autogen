...
def is_docker_running():
    ...
    """
    # Docker is None if the docker package is not installed
    if docker is None:
        return False
    try:
...
def execute_code(
    ...
    check_can_use_docker_or_throw(use_docker)  # If it wants to use docker and it cannot, it will throw an error
    ...
    os.makedirs(file_dir, exist_ok=True)  # Create the folder
